...
SELECT employee_id, last_name ,salary * 12 "ANNUAL SALARY"
FROM employees
where  "ANNUAL SALARY">50000;  --ORA-00904: "ANNUAL SALARY": invalid identifier

SELECT employee_id, last_name ,salary * 12 "ANNUAL SALARY"
FROM employees
where salary*12>50000
and employee_id<140
order by "ANNUAL SALARY" desc;  --atentie cum este scris aliasul
...
select sysdate
from dual; --28-FEB-24//  28-02-2024
--29-FEB-24

select to_char(sysdate, 'DAY /MM/ YEAR')
from dual; 
--WEDNESDAY /02/ TWENTY TWENTY-FOUR
--MIERCURI /02/ TWENTY TWENTY-FOUR

--THURSDAY  /02/ TWENTY TWENTY-FOUR
--JOI      /02/ TWENTY TWENTY-FOUR
...
from dual; 
--MIERCURI /Februarie / TWENTY TWENTY-FOUR
--JOI      /Februarie / TWENTY TWENTY-FOUR
...
----------------OPERATORUL LIKE ---------------
--Angajatii al caror nume sau prenume incepe cu 'A' (sa fie case sensitive)
select last_name, first_name
from employees
where last_name like 'A%'
or first_name like 'A%'; --14 rez

select last_name, first_name
from employees
where last_name like 'A%';  -- 3 rez
...
3200, 2700, 2500, 3100, 6200. (operatorul NOT IN)
